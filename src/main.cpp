...
const string strMessageMagic = "MutualCoin Signed Message:\n";
...
int64_t GetProofOfStakeReward(int nHeight, int64_t nCoinAge, int64_t nFees)
{
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8);
            ...
            {
            nSubsidy >>= nSubsidy /100000;  //no substantial pos reward until block 25k
            }

            else if(nBestHeight <= 50000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 50k
            }

            else if(nBestHeight <= 60000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 60k
            }

            else if(nBestHeight <= 100000)
            {
            nSubsidy = nSubsidy * 5 ;   //5000% until block 100k
            }

            else if(nBestHeight <= 110000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 110k
            }

            else if(nBestHeight <= 150000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 150k
            }

            else if(nBestHeight <= 160000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 160k
            }

            else if(nBestHeight <= 200000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 200k
            }

            else if(nBestHeight <= 210000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 210k
            }

            else if(nBestHeight <= 250000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 250k
            }

            else if(nBestHeight <= 260000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 260k
            }

            else if(nBestHeight <= 300000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 300k
            }

            else if(nBestHeight <= 310000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 310k
            }

            else if(nBestHeight <= 350000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 350k
            }

            else if(nBestHeight <= 360000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 360k
            }

            else if(nBestHeight <= 400000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 400k
            }

            else if(nBestHeight <= 410000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 410k
            }

            else if(nBestHeight <= 450000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 450k
            }

            else if(nBestHeight <= 460000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 460k
            }

            else if(nBestHeight <= 500000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 500k
            }

            else if(nBestHeight <= 510000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 510k
            }

            else if(nBestHeight <= 550000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 550k
            }

            else if(nBestHeight <= 560000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 560k
            }

            else if(nBestHeight <= 600000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 600k
            }

            else if(nBestHeight <= 610000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 610k
            }

            else if(nBestHeight <= 650000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 650k
            }

            else if(nBestHeight <= 660000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 660k
            }

            else if(nBestHeight <= 700000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 700k
            }

            else if(nBestHeight <= 710000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 710k
            }

            else if(nBestHeight <= 750000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 750k
            }

            else if(nBestHeight <= 760000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 760k
            }

            else if(nBestHeight <= 800000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 800k
            }

            else if(nBestHeight <= 810000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 810k
            }

            else if(nBestHeight <= 850000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 850k
            }

            else if(nBestHeight <= 860000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 860k
            }

            else if(nBestHeight <= 900000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 900k
            }

            else if(nBestHeight <= 910000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 910k
            }

            else if(nBestHeight <= 950000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 950k
            }

            else if(nBestHeight <= 960000)
            {
            nSubsidy = nSubsidy * 10 ;  //10000% until block 960k
            }

            else if(nBestHeight <= 1000000)
            {
            nSubsidy = nSubsidy * 5 ;  //5000% until block 1000k
            }

            else if(nBestHeight <= 9999999)
            {
            nSubsidy = nSubsidy * 1 ;  //1000% after block 1000k
            }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MutualCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Tuesday, October 31, 2017 8:32:58 AM";
        CTransaction txNew;
        txNew.nTime = 1509438778;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x3406b6f46784d21eb7d9bcbd414b6ad83f93daf962a3843fbf7e326a1fac7278"));
